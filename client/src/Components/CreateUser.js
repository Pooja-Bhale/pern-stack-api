...
const CreateUser = () =>{
    ...
    const onSubmitForm = async(e) => {
        e.preventDefault();
        try {
            const body = { FirstName, LastName, Address, OrganizationName, Phone, Email };
    ...
    return (
        <Fragment>
            <h1 className="text-center mt-5">
                ...
                <Form onSubmit={ onSubmitForm }  className="col-md-6" Style="text-align:left;">
                   ...
                   <div className="form-group">                    
                        ...
                        <Field type="text" 
                           ...
                           value= {FirstName}
                           onChange={e => { setFirstName(e.target.value);  setFieldValue("FirstName",e.target.value); } }
                           />
                    ...
                    <div className="form-group">  
                        ...
                        <Field type="text" 
                           name="LastName"
                           value= {LastName}
                           onChange={e => {setLastName(e.target.value); setFieldValue("LastName",e.target.value); }} 
